  ...
  return (
    <>
      ...
      <nav style={s.bnav} role="navigation" aria-label="Navigation principale">
        ...
        <NavIcon id="coach" label={Object.keys(IAS).length + " IA"} ariaLabel="Coach IA" needsOnline><svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#C9A84C" strokeWidth="1.8" strokeLinecap="round"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z" /></svg></NavIcon>
