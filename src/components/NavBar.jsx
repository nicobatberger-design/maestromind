...
export default function NavBar() {
  ...
  const NavIcon = ({ id, label, children, needsOnline }) => (
    <div style={{ ...s.ni, opacity: needsOnline && !isOnline ? 0.3 : 1 }} onClick={() => goPage(id)}>
  ...
  return (
    <>
      ...
      <div style={s.bnav}>
        ...
        <NavIcon id="coach" label="32 IA" needsOnline><svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#C9A84C" strokeWidth="1.8" strokeLinecap="round"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z" /></svg></NavIcon>
        <NavIcon id="scanner" label="Scanner" needsOnline><svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#C9A84C" strokeWidth="1.8" strokeLinecap="round"><path d="M23 19a2 2 0 0 1-2 2H3a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h4l2-3h6l2 3h4a2 2 0 0 1 2 2z" /><circle cx="12" cy="13" r="4" /></svg></NavIcon>
