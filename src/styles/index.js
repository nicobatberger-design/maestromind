const s = {
  ...
  chip: { background:"rgba(255,255,255,0.03)", border:"0.5px solid rgba(255,255,255,0.08)", borderRadius:20, padding:"8px 14px", fontSize:10, color:"rgba(240,237,230,0.5)", cursor:"pointer", transition:"all 0.2s", minHeight:44, display:"flex", alignItems:"center" },
