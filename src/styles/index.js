const s = {
  ...
  divPill: { flexShrink:0, padding:"8px 14px", borderRadius:20, border:"0.5px solid rgba(255,255,255,0.07)", fontSize:10, fontWeight:600, color:"rgba(240,237,230,0.45)", cursor:"pointer", background:"transparent", whiteSpace:"nowrap", transition:"all 0.2s", minHeight:44, display:"flex", alignItems:"center" },
  iaSel: { display:"flex", gap:5, marginBottom:10, overflowX:"auto", paddingBottom:2, scrollbarWidth:"none" },
  iap: { flexShrink:0, padding:"8px 14px", borderRadius:20, border:"0.5px solid rgba(255,255,255,0.07)", fontSize:10, fontWeight:600, color:"rgba(240,237,230,0.45)", cursor:"pointer", background:"transparent", whiteSpace:"nowrap", transition:"all 0.2s", minHeight:44, display:"flex", alignItems:"center" },
  iapOn: { flexShrink:0, padding:"8px 14px", borderRadius:20, border:"0.5px solid #C9A84C", fontSize:10, fontWeight:600, color:"#C9A84C", cursor:"pointer", background:"rgba(201,168,76,0.1)", whiteSpace:"nowrap", minHeight:44, display:"flex", alignItems:"center" },
  chips: { display:"flex", gap:6, flexWrap:"wrap", marginBottom:10 },
  chip: { background:"rgba(255,255,255,0.03)", border:"0.5px solid var(--border)", borderRadius:20, padding:"8px 14px", fontSize:10, color:"var(--text-secondary)", cursor:"pointer", transition:"all 0.2s", minHeight:44, display:"flex", alignItems:"center" },
