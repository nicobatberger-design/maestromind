const s = {
  ...
  hdr: { padding:"14px 16px 12px", display:"flex", alignItems:"center", justifyContent:"space-between", background:"rgba(6,8,13,0.75)", backdropFilter:"blur(32px) saturate(1.4)", WebkitBackdropFilter:"blur(32px) saturate(1.4)", borderBottom:"0.5px solid rgba(201,168,76,0.08)", flexShrink:0, boxShadow:"0 4px 24px rgba(0,0,0,0.3)" },
  ...
  bubA: { maxWidth:"82%", padding:"12px 16px", borderRadius:"4px 18px 18px 18px", fontSize:13, lineHeight:1.7, letterSpacing:"0.01em", color:"#D4D4E8", background:"rgba(12,16,24,0.75)", backdropFilter:"blur(16px) saturate(1.3)", WebkitBackdropFilter:"blur(16px) saturate(1.3)", border:"0.5px solid rgba(255,255,255,0.1)", boxShadow:"inset 0 1px 0 rgba(255,255,255,0.06), 0 4px 16px rgba(0,0,0,0.35)" },
  bubU: { maxWidth:"82%", padding:"12px 16px", borderRadius:"18px 4px 18px 18px", fontSize:13, lineHeight:1.7, letterSpacing:"0.01em", background:"linear-gradient(135deg,#8A6820,#C9A84C,#EDD060,#F5E6A3)", color:"#06080D", fontWeight:500, boxShadow:"0 4px 20px rgba(201,168,76,0.32), inset 0 1px 0 rgba(255,255,255,0.2)" },
  ...
  card: { background:"rgba(12,16,24,0.55)", backdropFilter:"blur(20px) saturate(1.3)", WebkitBackdropFilter:"blur(20px) saturate(1.3)", border:"0.5px solid rgba(201,168,76,0.1)", borderRadius:16, padding:"16px 16px", marginBottom:10, boxShadow:"0 4px 24px rgba(0,0,0,0.2), inset 0 1px 0 rgba(255,255,255,0.06)" },
  inp: { background:"rgba(6,8,13,0.8)", border:"0.5px solid rgba(201,168,76,0.15)", borderRadius:12, padding:"12px 16px", color:"#F0EDE6", fontSize:13, outline:"none", fontFamily:"'DM Sans',sans-serif", width:"100%", WebkitAppearance:"none", transition:"border-color 0.25s, box-shadow 0.25s" },
  ...
  bnav: { position:"absolute", bottom:0, left:0, right:0, background:"rgba(6,8,13,0.7)", backdropFilter:"blur(32px) saturate(1.5)", WebkitBackdropFilter:"blur(32px) saturate(1.5)", borderTop:"0.5px solid rgba(201,168,76,0.08)", display:"flex", padding:"8px 0 14px", zIndex:100, boxShadow:"0 -16px 48px rgba(0,0,0,0.5), inset 0 1px 0 rgba(255,255,255,0.04)" },
